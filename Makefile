##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Sun Nov 20 20:14:01 MSK 2022]
##########################################################################################################################
...
#######################################
prog: all
	openocd -f interface/stlink-v2.cfg -f target/stm32f0x.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify exit reset"
